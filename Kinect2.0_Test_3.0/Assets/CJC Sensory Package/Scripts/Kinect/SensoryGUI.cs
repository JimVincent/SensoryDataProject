	...
	void Update () 
	{
		if(panelOpen)
		{
			...
			if(breath.GetIsTracking())
			{
				...
				ui.lSlider.minValue = -KinectDataSensors.inst.leanSensitivty;
				ui.lSlider.maxValue = KinectDataSensors.inst.leanSensitivty;
				ui.lSlider.value = KinectDataSensors.inst.GetLean();
